...
class TestMultiInstanceTools:
    ...
    @pytest.mark.asyncio
    async def test_get_all_items_multi_instance_all_instances(self, mock_jenkins, multi_instance_ctx):
    ...
    @pytest.mark.asyncio
    async def test_get_all_items_multi_instance_specific_instances(self, mock_jenkins, multi_instance_ctx):
        """Test getting items from specific instances."""
        mock_item = Mock()
        mock_item.model_dump.return_value = {'name': 'test-job'}
        mock_jenkins.get_items.return_value = [mock_item]

        result = await get_all_items_multi_instance(multi_instance_ctx, instances=['instance1'])
    ...
    @pytest.mark.asyncio
    async def test_get_all_items_multi_instance_no_config(self, mock_jenkins, single_instance_ctx):
    ...
    @pytest.mark.asyncio
    async def test_get_running_builds_multi_instance(self, mock_jenkins, multi_instance_ctx):
    ...
    @pytest.mark.asyncio
    async def test_get_all_queue_items_multi_instance(self, mock_jenkins, multi_instance_ctx):
